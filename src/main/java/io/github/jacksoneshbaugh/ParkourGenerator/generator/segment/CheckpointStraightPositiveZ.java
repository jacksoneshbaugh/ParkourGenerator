...
/**
 * A straight "checkpoint" segment in the positive z direction.
 *
 * @author Jackson Eshbaugh
 * @version 05/26/2024
 */
public class CheckpointStraightPositiveZ extends ParkourSegment {

    public CheckpointStraightPositiveZ() {
